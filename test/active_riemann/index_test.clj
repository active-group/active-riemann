...
(defn cleanup-message [message]
  (cond
    (string/includes? (first message) "active-riemann.index/try-store-edn no riemann-index backup file specified: nil")
    ["active-riemann.index/try-store-edn no riemann-index backup file specified: nil"]
    (string/includes? (first message) "active-riemann.index/try-store-edn Successfully stored riemann-index backup file:")
